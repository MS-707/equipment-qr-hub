...
### A3 — Zod validation drop destroys legal records on schema drift — `TODO`
**Profession:** Data-reliability engineer
...
### A4 — Archiver deletes the only copy of post-sync mutations — `TODO`
...
### A5 — Horizontal swipe exits an in-progress inspection (data loss on the daily path) — `TODO`
