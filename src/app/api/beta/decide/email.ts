    ...
    await fetchWithTimeout(RESEND_URL, {
      ...
      body: JSON.stringify({
        ...
        text: [
          ...
          ``,
          `Your data is stored on your device (offline-first PWA). Optional features`,
          `like AI assist and EHS review send work context to our servers when used.`,
          `See our privacy policy at ${appUrl}/privacy for details.`,
          ``,
